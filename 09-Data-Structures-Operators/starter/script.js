...
const maskCreditCard = function (number) {
  const str = number + '';
  const last = str.slice(-4); // 後ろから４つまで
  return last.padStart(str.length, '*');
}

console.log(maskCreditCard(43354352652643));
console.log(maskCreditCard('454545465555566663'));
...
// const staffUnique = new Set(staff); // object
const staffUnique = [...new Set(staff)]; // array
console.log(staffUnique);
// for (const item of staffUnique) console.log(item);
